...
describe("units", () => {
  describe("#getUnit", () => {
    it("gets unit of spacefarm", () => {
      const result = units.getUnit("spacefarm");
    ...
    it("gets unit of spacefarm using alias", () => {
  ...
  describe("#getDisplay", () => {
    it("gets display of spacefarm", () => {
      const result = units.getDisplay("spacefarm");
  ...
  describe("#setUnit", () => {
    ...
    it("modifies an existing unit", () => {
      units.setUnit("spacefarm", 9);

      const result = units.getUnit("spacefarm");

      expect(result).toEqual(9);

      units.setUnit("spacefarm", 1);
    });
  });
  describe("#setDisplay", () => {
