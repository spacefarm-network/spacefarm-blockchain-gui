...
import { CardStep, ConfirmDialog, Link, Select, StateColor } from '@spacefarm/core';
    ...
    >
      <Typography variant="subtitle1">
        <Trans>
          ...
          <Link target="_blank" href="https://github.com/spacefarm-network/spacefarm-blockchain/wiki/k-sizes">Learn more</Link>
        </Trans>
      </Typography>
