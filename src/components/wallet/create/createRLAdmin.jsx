...
export const CreateRLAdminWallet = () => {
  ...
  function create() {
    ...
    if (
      spacefarmper_input.value === '' ||
      Number(spacefarmper_input.value) === 0 ||
      !Number(spacefarmper_input.value) ||
      isNaN(Number(spacefarmper_input.value))
    ) {
      dispatch(
        openDialog(
          <AlertDialog>
    ...
    const spacefarmper = spacefarm_to_mojo(spacefarmper_input.value);
    const spacefarmper_value = Number.parseInt(Number(spacefarmper));
    ...
    // var fee = spacefarm_to_mojo(fee_input.value);
