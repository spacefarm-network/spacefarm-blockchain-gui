...
import { AlertDialog, Flex, Card } from '@spacefarm/core';
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of spacefarm in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of Spacefarm that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and Spacefarm that you have just spent but is not
...
function SendCard(props: SendCardProps) {
  ...
  function send() {
    ...
    if (address.includes('colour')) {
      dispatch(
        openDialog(
          <AlertDialog>
            <Trans>
              Error: Cannot send spacefarm to coloured address. Please enter a spacefarm
              address.
            </Trans>
          </AlertDialog>,
        ),
    ...
    if (address.slice(0, 12) === 'spacefarm_addr://') {
