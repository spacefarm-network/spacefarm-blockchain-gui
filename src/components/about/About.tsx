...
import icon from '../../assets/img/spacefarm_circle.svg';
    ...
    <html>
      ...
      <body>
        ...
        <div className="copyright">
          Copyright (c) 2021 Chia Network, Spacefarm Network
        </div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
        ...
        <BugReport href="https://github.com/spacefarm-network/spacefarm-blockchain/issues" target="_blank">
          Report an issue
        </BugReport>
        {'{{CSS}}'}
      </body>
